...
public class BookingController : ControllerBase
{
    ...
    [HttpDelete]
    // Declares a public method named Delete that takes a Booking parameter and returns an IActionResult.
    public IActionResult Delete(Booking booking)
    {
        // Calls the Delete method of the _bookingRepository field with the booking parameter and assigns the result to a local variable named result.
